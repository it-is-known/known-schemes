...
[![Package](https://img.shields.io/gem/v/known-schemes)](https://rubygems.org/gems/known-schemes)
[![Documentation](https://img.shields.io/badge/rubydoc-latest-blue)](https://rubydoc.info/gems/known-schemes)

Well-known URI/IRI schemes for Ruby.

## 👉 Examples

### Importing well-known schemes

```ruby
require 'known/schemes'
```
